...
public class FadingIndicator extends View implements ViewPager.OnPageChangeListener{
    ...
    public FadingIndicator(Context context, AttributeSet attrs) {
        ...
        try {
            radius = attributes.getDimension(R.styleable.FadingIndicator_fadradius, radius);
            fillColor = attributes.getColor(R.styleable.FadingIndicator_fadfillColor, Color.DKGRAY);
            strokeColor = attributes.getColor(R.styleable.FadingIndicator_fadstrokeColor, Color.BLACK);
