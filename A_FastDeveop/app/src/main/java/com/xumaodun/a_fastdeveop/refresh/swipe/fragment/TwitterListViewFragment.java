...
import com.xumaodun.a_fastdeveop.refresh.adapter.LoopViewPagerAdapter;
...
import com.xumaodun.a_fastdeveop.refresh.adapter.SectionAdapter;
import com.xumaodun.a_fastdeveop.refresh.model.Character;
...
public class TwitterListViewFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener,
    ...
    public void onRefresh() {
        ...
        AppContext.getRequestQueue().add(request).setTag(TAG);
    }
