package com.xumaodun.a_fastdeveop.newsstand;
...
public class NewsstandActivity extends AppCompatActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager = (ViewPager) findViewById(R.id.npager);
