...
import com.xumaodun.a_fastdeveop.refresh.adapter.OnChildItemClickListener;
import com.xumaodun.a_fastdeveop.refresh.adapter.OnChildItemLongClickListener;
import com.xumaodun.a_fastdeveop.refresh.adapter.RecyclerCharactersAdapter;
...
public class TwitterRecyclerFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,
    ...
    public void onPause() {
        super.onPause();
        AppContext.getRequestQueue().cancelAll(TAG + "refresh" + mType);
        AppContext.getRequestQueue().cancelAll(TAG + "loadmore" + mType);
    ...
    public void onLoadMore() {
        ...
        AppContext.getRequestQueue().add(request).setTag(TAG + "loadmore" + mType);
    }
    ...
    public void onRefresh() {
        ...
        AppContext.getRequestQueue().add(request).setTag(TAG + "refresh" + mType);
    }
}
